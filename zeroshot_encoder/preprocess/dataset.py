...
def get_dset(
        ...
        tr_map_func: Callable = None, vl_map_func: Callable = None, remove_columns: Union[str, List[str]] = None,
    ...
    if tr_map_func is not None:
        ...
        tr = tr.map(tr_map_func, batched=True, remove_columns=remove_columns, num_proc=num_proc)
        vl = vl.map(vl_map_func, batched=True, remove_columns=remove_columns, num_proc=num_proc)
