...
def get_dset(
        ...
        d_map_func: Dict[str, Callable] = None, remove_columns: Union[str, List[str]] = None,
    ...
    if 'UTCD' in dataset_name:
        ...
        dset = datasets.load_from_disk(os.path.join(out_base, DIR_PROJ, DIR_DSET, 'processed', dataset_name))
    else:
